...
| `INI_EDIT_ENABLED` | `false` | INI .ini/.cfg/.conf creation and section.key-based editing (`[section]` headers, `#`/`;` comments; comments and formatting preserved); needs FILE_READ_ENABLED too |
